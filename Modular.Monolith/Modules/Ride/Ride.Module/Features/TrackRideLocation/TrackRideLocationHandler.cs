...
/// Remote-only, so no controller — same shape as Features/GetActiveRideForHub.
/// </summary>
internal class TrackRideLocationHandler(RideDbContext db) : IRequestHandler<SharedTrackRideLocation>
{
