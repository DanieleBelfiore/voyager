...
public class Program
{
  ...
  private const string HUB_API = "http://localhost:5300/voyagerhub";
  private const string IDENTITY_API = "http://localhost:5301";
  private const string DRIVER_API = "http://localhost:5302";
  private const string RIDE_API = "http://localhost:5303";
