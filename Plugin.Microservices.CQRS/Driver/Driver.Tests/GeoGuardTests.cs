...
/// <summary>
/// Covers Common.Core's coordinate guard. It lives in Driver.Tests for the same reason
/// RedisCacheServiceTests does: Common.Core has no test project of its own, and Driver.Handlers
/// is the reference that makes it reachable.
/// </summary>
public class GeoGuardTests
{
  ...
  public void Required_Throws_WhenPointIsMissing()
  {
    ...
    // that simply omits the location bound to null and reached the handler, where writing it as
    // WKT threw a NullReferenceException and surfaced as a 500.
