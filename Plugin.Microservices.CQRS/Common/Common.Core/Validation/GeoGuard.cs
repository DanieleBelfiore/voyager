...
/// <summary>
/// Rejects a caller-supplied coordinate before it reaches EF Core or any geometry writer.
///
...
/// performs no automatic model-state check: a body that simply omits a location bound to null
/// and reached the handler, where WKTWriter.Write(null) threw a NullReferenceException and came
/// back as a 500. An out-of-range latitude got further still — SQL Server's geography type
/// rejects it at INSERT time, which is also a 500. Both are bad input and belong at 400.
/// </summary>
