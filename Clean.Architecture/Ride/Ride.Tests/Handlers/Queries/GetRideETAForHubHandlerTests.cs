...
public class GetRideETAForHubHandlerTests
{
  ...
  private readonly GetRideETAForHubHandler _handler;

  public GetRideETAForHubHandlerTests()
  {
    _config.AverageSpeedKmh.Returns(30.0);
    _handler = new GetRideETAForHubHandler(_repository, _driverLocation, _config);
  }
  ...
  public async Task Handle_ReturnsEta_WhenDriverLocationKnown()
  {
    ...
    // Act
    var result = await _handler.Handle(new SharedGetRideETA { Id = ride.Id, CallerId = ride.DriverId }, CancellationToken.None);
  ...
  public async Task Handle_Throws_WhenRideNotFound()
  {
    ...
    var act = () => _handler.Handle(new SharedGetRideETA { Id = Guid.NewGuid() }, CancellationToken.None);
  ...
  public async Task Handle_Throws_WhenCallerIsNotARideParticipant()
  {
    ...
    await Assert.ThrowsAsync<UnauthorizedAccessException>(() =>
      _handler.Handle(new SharedGetRideETA { Id = ride.Id, CallerId = Guid.NewGuid() }, CancellationToken.None));
