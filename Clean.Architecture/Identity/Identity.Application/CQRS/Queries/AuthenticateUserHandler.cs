...
public class AuthenticateUserHandler(IUserRepository repository, IPasswordHasher passwordHasher) : IRequestHandler<AuthenticateUser, AuthenticateUserResult>
{
