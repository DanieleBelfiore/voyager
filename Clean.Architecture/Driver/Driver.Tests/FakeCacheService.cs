...
/// <summary>
/// Minimal in-memory stand-in for Application's cache port, so cache-aside behaviour
/// (GetDriverStatus_ShouldUseCacheOnSecondCall) can be exercised without any Infrastructure
/// dependency — a true unit test against the port, not against Redis/EF.
/// </summary>
