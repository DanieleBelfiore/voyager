...
namespace Driver.Application.Validation;
...
///
/// It sits in Application rather than Domain because it guards a request boundary, and it is
/// duplicated per service rather than shared: Application may only reference its own Domain and
/// Voyager.Contracts, so a cross-service helper has nowhere to live that does not break the
/// dependency rule.
/// </summary>
