...
public class Program
{
  ...
  private const string HUB_API = "http://localhost:5100/voyagerhub";
  private const string IDENTITY_API = "http://localhost:5101";
  private const string DRIVER_API = "http://localhost:5102";
  private const string RIDE_API = "http://localhost:5103";
