...
builder.Services.AddHubSecondaryAdapters(configuration);

// SignalRHubRelay lives in this project (not Hub.Adapters.Secondary) because it's generic over
// the concrete VoyagerHub type — see SignalRHubRelay.cs.
builder.Services.AddScoped<IHubRelay, SignalRHubRelay>();

builder.Services.AddScoped<IUpdateDriverLocationUseCase, UpdateDriverLocationUseCase>();
