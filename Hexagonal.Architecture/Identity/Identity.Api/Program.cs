...
using Arbitrer;
using Identity.Adapters.Secondary.DependencyInjection;
...
builder.Services.AddIdentitySecondaryAdapters(configuration);

builder.Services.AddScoped<IRegisterUserUseCase, RegisterUserUseCase>();
builder.Services.AddScoped<IAuthenticateUserUseCase, AuthenticateUserUseCase>();
builder.Services.AddScoped<IUpdateUserRatingUseCase, UpdateUserRatingUseCase>();
builder.Services.AddScoped<IGetUsersRatingsUseCase, GetUsersRatingsUseCase>();
...
var coreAssembly = typeof(RegisterUserUseCase).Assembly;
