...
// Composition root: secondary adapters wired into Core's secondary ports, and primary ports
// wired directly to their use case implementations for local (non-mediator) injection.
builder.Services.AddRideSecondaryAdapters(configuration);

builder.Services.AddScoped<IRequestRideUseCase, RequestRideUseCase>();
builder.Services.AddScoped<IAcceptRideUseCase, AcceptRideUseCase>();
...
builder.Services.AddScoped<IRateRideUseCase, RateRideUseCase>();
builder.Services.AddScoped<IRateDriverUseCase, RateDriverUseCase>();
builder.Services.AddScoped<IGetRideDetailsUseCase, GetRideDetailsUseCase>();
builder.Services.AddScoped<IGetRideCurrentLocationUseCase, GetRideCurrentLocationUseCase>();
builder.Services.AddScoped<IGetRideHistoryUseCase, GetRideHistoryUseCase>();
builder.Services.AddScoped<IGetRideDriverHistoryUseCase, GetRideDriverHistoryUseCase>();
