...
/// </summary>
public class TrackRideLocationUseCaseTests
{
  private readonly IRideRepository _repository = Substitute.For<IRideRepository>();
  private readonly TrackRideLocationUseCase _handler;

  public TrackRideLocationUseCaseTests()
  {
    _handler = new TrackRideLocationUseCase(_repository);
  }
